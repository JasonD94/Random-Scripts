...
$INTERNAL_BACKUP_PATH >> ~/_Sync_Logs/sync_"$now"_"$the_time".log 2>&1
...
$MTP_PATH/SD\ card/ \
$EXTERNAL_BACKUP_PATH >> ~/_Sync_Logs/sync_"$now"_"$the_time".log 2>&1
